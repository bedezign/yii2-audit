...
<div class="javascript-index">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <ul>
                <li><?= Html::a(Yii::t('app', 'create log'), 'javascript:window.jsLogger.log("this is a log")'); ?> (not logged on server)</li>
                <li><?= Html::a(Yii::t('app', 'create info'), 'javascript:window.jsLogger.info("this is some info")'); ?> (not logged on server)</li>
