            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        SOAP
                        <span class="pull-right">
                            <?= Html::a('create', ['/soap/index'], ['class' => 'btn btn-default btn-xs']) ?>
                        </span>
                    </h3>
                </div>
                <div class="panel-body">
                    <p>If you used the built-in <code>SoapClient</code> (either directly or to derive from),
                        Audit can track your SOAP calls for you</p>
                </div>
            </div>
        </div>    </div>
</div>
