        ...
        <div class="col-md-2">
            <ul class="nav nav-pills nav-stacked affix">
                ...
                <?php foreach ($model->extraData as $extraData): ?>
                    <li>
                        <a href="#<?= $extraData->type ?>"><?= $extraData->type . ' (' . count($extraData->data) . ')' ?></a>
                    </li>
                <?php endforeach ?>
                ...
                <?php if (count($model->linkedErrors)): ?>
                    <li>
                        <a href="#errors"><?= Yii::t('audit', 'Errors ({i})', ['i' => count($model->linkedErrors)]) ?></a>
                    </li>
                <?php endif ?>

                <?php if (count($model->javascript)): ?>
                    <li>
                        <a href="#javascript"><?= Yii::t('audit', 'Javascript ({i})', ['i' => count($model->javascript)]) ?></a>
                    </li>
                <?php endif ?>
            </ul>
        </div>
